...
Please use the default [mopidy.conf of the addon](https://github.com/llntrvr/Hassio-Addons/blob/main/mopidy/root/etc/mopidy-template.conf) as starting point.
